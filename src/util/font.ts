...
const fonts: Font[] = [{
    ...
    gap: 1,
    underline: 10,
    widths: [6, 7, 6, 6, 7, 6, 4, 6, 6, 1, 3, 5, 4, 8, 6, 6, 6, 6, 5, 6, 5, 6, 7, 7, 5, 7, 6, 6, 6, 6, 6, 5, 7, 6, 6, 3, 5, 5, 5, 7, 7, 6, 6, 7, 6, 6, 7, 6, 7, 7, 5, 5, 5, 1, 2, 1, 5, 1, 2, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 5, 5, 4, 4, 1, 3, 1, 2, 2, 6, 9, 5, 6, 7, 3, 3, 2, 2, 2, 2, 7, 6, 3, 7, 6, 6, 3, 3, 10, 10, 10, 7, 10, 10, 10, 10, 8, 8],
    gapOverrides: [{
        first: 'f',
